...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        "service_grjxuuv", // Your EmailJS service ID
        "template_z3avncb", // Your EmailJS template ID
        form.current,
        "fSGxMby2507IJN0sp" // Your EmailJS user ID
      )
      .then(
        (result) => {
          alert("Message Sent");
          form.current.reset(); // Correct method to reset the form
        },
        (error) => {
